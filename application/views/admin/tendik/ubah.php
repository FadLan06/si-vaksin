                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-9 mx-auto">
                                    <form action="<?= base_url('Tendik/Proses_edit') ?>" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input id="nama" type="text" class="form-control" name="nama" autocomplete="off" required value="<?= $tendik->nama ?>">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <input id="jabatan" type="text" class="form-control" name="jabatan" autocomplete="off" required value="<?= $tendik->jabatan ?>">
